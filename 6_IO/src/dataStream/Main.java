...
public class Main {
    public static void main(String[] args) {
        ...
        // запись в файл
        try (DataOutputStream dos = new DataOutputStream(new FileOutputStream(System.getProperty("user.dir") + "/data.bin"))) {
            // записываем значения
        ...
        try (DataInputStream dos = new DataInputStream(new FileInputStream(System.getProperty("user.dir") + "/data.bin"))) {
            // записываем значения
